...
// Implementacao de uma funcao que cria uma lista
void cria_lista(Lista **l){
  // Alocacao de memoria para armzenar o primeiro no (Cabeca)
  Lista *q = (Lista*) malloc(sizeof(Lista));

  // Seta o valor igual a 0 (armazena tamanho da lista)
  q->v = 0;

  // Aponta o proximo igual null
  q->prox = NULL;

  // Seta o no criado como primeiro elemento
  *l = q;
}
...
void libera_lista(Lista **l){
  ...
  // Enquanto o no cabeca nao for nulo
  while (*l != NULL) {
